...
<?= $this->section('title') ?>
    <title>Tefa IT - Tambah Kontak</title>
<?= $this->endSection() ?>

<?= $this->section('content') ?>

<div class="container mt-4">
    <form class="user" method="POST" action="<?= base_url('phonebook/tambah_contact') ?>">
        <div class="mb-4">
            <label for="number" class="form-label">Number</label>
            <textarea name="number" id="number" class="form-control" rows="5" placeholder="1 number per line, use | to add variable. Ex: 081|andi|indonesia..." required></textarea>
        </div>
        <div class="mb-4">
